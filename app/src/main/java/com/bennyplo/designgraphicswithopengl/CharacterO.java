...
public class CharacterO extends CharacterBase {
    private final int RESOLUTION = 50;
    private final double BEGIN_ANGLE = 0 * PI / 180;
    private final double END_ANGLE = 360 * PI / 180;
    ...
    int[] getCharIndex() {
        if (index == null) {
            ...
            int gi1[] = generateIndex(0, vertexCount / 4 + 3, vertexCount / 2);
            int gi2[] = generateIndex(vertexCount / 4 + 4, vertexCount / 2, vertexCount / 2);
